// train-stl.cpp -- header-heavy realistic translation unit used as PGO
// training input for cc1plus (see README.md).  Exercises common STL
// containers, algorithms, std::function callbacks, and several class
// templates instantiated with multiple types.  Self-contained: standard
// headers only.
#include <vector>
#include <string>
#include <map>
