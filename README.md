...
|---|---|---|---|---|---|---|
| stock upstream GCC (fork point) | upstream `releases/gcc-14`, 14.4.1-prerelease | `820ff02b98af` (plain recipe) | ? | — | [28728349544](https://github.com/wow-look-at-my/gcc/actions/runs/28728349544) (in flight) | last upstream commit before any fork work; all rows below are cumulative on top of this |
...
| compile cache: no-sidecar rework | [#7](https://github.com/wow-look-at-my/gcc/pull/7), merged 2026-06-30 | `5226232bbe76` | ? | ? | [28728353893](https://github.com/wow-look-at-my/gcc/actions/runs/28728353893) (in flight) | pre-#13 anchor; the composed-A/B "base" side |
...
| fork tip (= #14 merge) | [#14](https://github.com/wow-look-at-my/gcc/pull/14), merged 2026-07-05 | `5c426dfddb81` | ? | ? | [28728357442](https://github.com/wow-look-at-my/gcc/actions/runs/28728357442) (in flight) | current `develop-matt/v14` |
